#This is my 3-D shape for the graphics assignment!
#Alex Moore, Hunter College, CS Topics
...
prism_points = [n for n in range(4)]
prism_points[0] = [[0],[1],[-1]]
prism_points[1] = [[-1],[-1],[1]]
prism_points[2] = [[0],[1],[1]]
prism_points[3] = [[1],[-1],[1]]
...
# HW- Finishing connecting the points of the prism.
