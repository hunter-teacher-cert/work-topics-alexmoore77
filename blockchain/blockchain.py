...
myBlockchain.new_transaction("Alex","Iulian",15)

# STEP 4 add the new block to the chain using the new_block() by passing a proof argument for each
myBlockchain.new_block(proof1)
# STEP 5 Print the chain with the new changes
print(myBlockchain.chain)

# STEP 6 Repeat steps 3-5 to record two more transactions

myBlockchain.new_transaction("Alex","Eric", 20)
myBlockchain.new_block(proof2)
print(myBlockchain.chain)

myBlockchain.new_transaction("Alex","Peter", 25)
myBlockchain.new_block(proof3)
print(myBlockchain.chain)
